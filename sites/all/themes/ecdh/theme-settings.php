 ...
 */
function ecdh_form_system_theme_settings_alter(&$form, &$form_state, $form_id = NULL) {
  ...
  $form['ecdh_example'] = array(
  '#type'          => 'checkbox',
  '#title'         => t('ecdh sample setting'),
  '#default_value' => theme_get_setting('ecdh_example'),
